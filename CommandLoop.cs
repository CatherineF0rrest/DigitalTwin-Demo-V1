...
namespace DigitalTwinsClientApp
{
    public class CommandLoop
    {
        ...
        /// </summary>
        public async Task CommandSetupMewpulDemo(string[] cmd)
        {
            Log.Out($"Initializing MewpulDemo...");
            var b = new MewpulDemo(this);
        ...
        private void CliInitialize()
        {
            commands = new Dictionary<string, CliInfo>
            {
                ...
                { "SetupMewpulDemo", new CliInfo { Command=CommandSetupMewpulDemo, Category = CliCategory.SampleScenario, Help="loads a set of models and creates a very simple example twins graph" } },
